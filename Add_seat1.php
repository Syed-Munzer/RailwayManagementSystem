...
if(isset($_POST["tno"]))
{
    ...
    echo "<table><thead><td>Train_no</td><td>Train_name</td><td>Starting_point</td><td>Starting_time</td><td>Destination_point</td><td>Destination_time</td><td>Date_Of_Journey</td></thead>";
    echo "<tr><td>" . $cdrow[0] . "</td><td>" . $cdrow[1] . "</td><td>" . $cdrow[2] . "</td><td>" . $cdrow[3] . "</td><td>" . $cdrow[4] . "</td><td>" . $cdrow[5] . "</td><td>" . $doj . "</td></tr></table>";

    $cdquery = "SELECT sname FROM schedule where trainno='" . $trainno . "' ";
    $cdresult = mysqli_query($conn, $cdquery);
    $stations = array();
    $i = 0;
    ...
    echo "<form action=\"Add_seat2.php\" method=\"post\">";
    $temp = 0;
    ...
    echo "
    <form action=\"Add_seat1.php\" method=\"post\">
    <table>
