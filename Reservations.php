...
<form action="Booking_cond.php" method="post">
...
if(mysqli_num_rows($query) == 0)
{
 ...
 echo " <br><a href=\"http://localhost/railway/Info_result.php\">Go Back</a> <br>";
 die();
}
...
echo "<a href=\"http://localhost/railway/Info.php\">Back to Enquiry</a>";
